...
def get_args_parser():
    ...
    # [新增参数] 梯度累加步数：64 * 4 = 等效 256 超大 Batch
    ...
    parser.add_argument('--data_path', default='./processed_data_sinogram', type=str)
    parser.add_argument('--output_dir', default='./output_dir', help='模型保存路径')
