...
def get_args_parser():
    ...
    parser.add_argument('--patch_size', default=8, type=int, help='Patch tokenization size')
    ...
    parser.add_argument('--output_dir', default='./output_dir_new', help='模型保存路径')
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        plt.plot(range(len(train_losses)), train_losses, label='v-prediction MSE Loss', color='blue',
                 linewidth=2)
        plt.yscale('log')
        plt.xlabel('Epochs')
